...
<div class="row">
    <div class='col-md-4'>
        <div class="card">
            ...
            <div class="card-body">
                <p class="card-text lead"><span><b>{{$setting_total or 0 }}</b></span>
                    Global settings</p>
            </div>
        </div>
    </div>
    <div class='col-md-4'>
        <div class="card">
            ...
            <div class="card-body">
                <p class="card-text lead"><span><b>{{$page_total or 0 }}</b></span>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="card-text lead">
                    <span ><b>{{isset($meta_tag_total)?$meta_tag_total: 0 }}</b></span>
                    Meta Tags
                </p>
            </div>
        </div>
