        ...
        <div class="col-sm-12 text-right">
            <div class="btn-group">
                    ...
                    <a class="btn btn-warning" target="_blank"
                       href="https://developers.facebook.com/tools/debug/sharing/?q={{urlencode($record->path)}}">
                        <i class="fab fa-facebook"></i> Validate
                    </a>
                    <a class="btn btn-info" href="https://cards-dev.twitter.com/validator"
                       target="_blank">
                        <i class="fab fa-twitter"></i> Card Validate
                    </a>
                    <a class="btn btn-primary" target="_blank"
                       href="https://developers.google.com/speed/pagespeed/insights/?url={{urlencode($record->path)}}">
                        <i class="fab fa-google"></i> Page Speed
                    </a>
